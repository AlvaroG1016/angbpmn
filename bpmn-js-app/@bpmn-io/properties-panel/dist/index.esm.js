...
function Header(props) {
  ...
  const translatedType = customTranslate(type);
...
function DataMarker(props) {
  ...
  if (edited) {
    return jsx("div", {
      title: "Esta seccion contiene datos",
    ...
    children: [jsxs("div", {
      ...
      children: [jsx("div", {
        ...
        children: [add ? jsxs("button", {
          ...
          title: `La lista contiene ${items.length} item${items.length != 1 ? 's' : ''}`,
